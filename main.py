...
model.save('D:\\PROJECTS\\Handwritten Digit Recognition Project\\handwritten.model')

model= tf.keras.models.load_model('D:\\PROJECTS\\Handwritten Digit Recognition Project\\handwritten.model')
